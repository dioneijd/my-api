...
const pages = {
    ...
    PageOfSecretFriend: () => {
        ...
        html += c.SetButton('Groups', '/help/sf/groups')
        html += c.SetButton('Person', '/help/sf/p')
    ...
    PageOfGroups: () => {
        ...
        html  = c.SetPageHeader('MY API', 'SECRET FRIENDS > Groups')
        html += HelpOfGroups()
    ...
    PageOfPerson: () => {
        ...
        html  = c.SetPageHeader('MY API', 'SECRET FRIENDS > Person')
        html += HelpOfPerson()
