...
const SecretFriendHelpers = {
    ...
    HelpOfGroups: () => {
        ...
        temp  = '<b>Return 200:</b>'
        temp += b.ApiJsonReturn('{"_id": "6015ed2ea9d63d26d0450ea5","eventDate": "2021-12-25T00:00:00.000Z","people": [{"_id": "6015ed2ea9d63d26d0450ea6","name": "Dionei","friend": "Grasi"},{"_id": "6015ed2ea9d63d26d0450ea7","name": "Manu","friend": "Dionei"},{"_id": "6015ed2ea9d63d26d0450ea8","name": "Grasi","friend": "Manu"}],"createdAt": "2021-01-30T23:35:10.528Z","updatedAt": "2021-01-30T23:35:10.528Z","__v": 0}')
        html += b.SetBoxBody(temp)
        temp  = '<b>Return 400:</b>'
        temp += b.ApiJsonReturn('{"error": "046","errorMsg": "Group id 5fcc32cc708b471f9cef6a64 not found"}')
        html += b.SetBoxBody(temp)
        ...
        temp += b.ApiJsonReturn('{"error": "045", "errorMsg": "Its missing the group event date"}')
        html += b.SetBoxBody(temp)
        temp  = '<b>Return 500:</b>'
        ...
        html += b.SetBoxTitle('<b>GROUPS - DELETE </b>')
        html += b.SetBoxBody('<b>Url:</b> /sf/groups/:id')
        temp  = '<b>Return 200:</b>'
        temp += b.ApiJsonReturn('{"_id": "6015ed2ea9d63d26d0450ea5","eventDate": "2021-12-25T00:00:00.000Z","people": [{"_id": "6015ed2ea9d63d26d0450ea6","name": "Dionei","friend": "Grasi"},{"_id": "6015ed2ea9d63d26d0450ea7","name": "Manu","friend": "Dionei"},{"_id": "6015ed2ea9d63d26d0450ea8","name": "Grasi","friend": "Manu"}],"createdAt": "2021-01-30T23:35:10.528Z","updatedAt": "2021-01-30T23:35:10.528Z","__v": 0}')
        html += b.SetBoxBody(temp)
